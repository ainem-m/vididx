...
use vidx_core::{SilenceInterval, VidxError};
...
pub async fn detect_silence(
    ...
    let output = Command::new(ffmpeg_path)
        ...
        .arg("-")
        .output()
        .map_err(|e| VidxError::Media(format!("ffmpeg silence detection failed: {}", e)))?;
...
fn parse_silence_output(output: &str) -> Result<Vec<SilenceInterval>, VidxError> {
